...
export default function SignatureSerumSection() {
  return (
    <section className="py-16 sm:py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <p className="text-gray-600 text-sm mb-2">MADE TO MATCH YOUR SKIN</p>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light">
            Our Signature Serum
          </h2>
        </div>
        <div className="flex justify-center">
          <Link href="/product/3" className="group max-w-md">
