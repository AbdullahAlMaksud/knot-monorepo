...
export default function TheCreamSection() {
  return (
    <section className="py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <p className="text-gray-600 text-sm mb-2">SOFTNESS IN EVERY TOUCH</p>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light">
            The Cream Your Skin Deserves
          </h2>
        </div>
        <div className="flex justify-center">
          <Link href="/product/4" className="group max-w-md">
