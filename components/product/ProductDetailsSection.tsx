      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className=" rounded-3xl ">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div>
              <p className="text-sm tracking-[0.2em] text-gray-600 mb-3">
              ...
              <div className="flex items-center gap-6 mb-8">
                <button
                  ...
                  className="w-14 h-14 rounded-full border-2 border-black flex items-center justify-center hover:bg-white hover:text-black transition"
              ...
              <div className="space-y-4">
                <button className="w-full bg-black text-white px-8 py-4 rounded-full font-medium hover:bg-gray-200 hover:text-black transition flex items-center justify-center gap-2 text-lg">
                  Add to cart
                  <svg
                    className="w-5 h-5"
                    fill="none"
                ...
                <button className="w-full border-2 border-black text-black px-8 py-4 rounded-full font-medium hover:bg-black hover:text-white transition flex items-center justify-center gap-2 text-lg">
                  Bye Now
