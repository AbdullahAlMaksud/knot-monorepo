    ...
    <section className="py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-gray-600 max-w-4xl mx-auto mb-8">
          ...
          every person achieve their healthiest, most radiant skin. Rooted in
          science and free of irritants, our products are carefully formulated
          to nurture your skin and deliver visible results.
        </p>
        <Link
          href="/shop"
